...
namespace CiaoApp.Web.Migrations
{
    ...
    [Migration("20170215144340_M_N_Tags")]
    partial class M_N_Tags
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("CiaoApp.Web.Models.Promises.Associations.Association", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("CiaoApp.Web.Models.Promises.TagAssociation", b =>
                {
                    b.Property<int>("BasePromiseId");

                    b.Property<int>("TagId");

                    b.HasKey("BasePromiseId", "TagId");

                    b.HasIndex("BasePromiseId");

                    b.HasIndex("TagId");

                    b.ToTable("TagAssociation");
                });
            ...
            modelBuilder.Entity("CiaoApp.Web.Models.Promises.TagAssociation", b =>
                {
                    b.HasOne("CiaoApp.Web.Models.Promises.BasePromise", "BasePromise")
                        .WithMany("Tags")
                        .HasForeignKey("BasePromiseId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("CiaoApp.Web.Models.Promises.Tag", "Tag")
                        .WithMany("AssociatedPromises")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
